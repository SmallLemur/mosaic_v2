...
def chains_and_angles(img_edges, half_tile):
    ...
    res = {
        ...
        'gradient':gradient,
        'angles_0to180':angles_0to180,
        'chains':chains,
    }

    return res#, interim_stages



def chains_into_gaps(polygons, h, w, half_tile, CHAIN_SPACING):
    ...
    res = {
        'chains2':chains2,
        'used_up_space':img_chains,
        'distance_to_tile':distance_to_tile,
        'filler_guidelines':guidelines2,
    }
