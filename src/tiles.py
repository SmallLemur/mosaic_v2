...
def place_tiles_along_chains(chains, angles_0to180, half_tile, RAND_SIZE, MAX_ANGLE, A0):
...
def place_tiles_into_gaps(polygons, filler_chains, half_tile, A0):
...
def cut_tiles_outside_frame(polygons, half_tile, w, h):
